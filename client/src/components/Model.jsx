...
const Model = ({mode, setShowModel, getData, userId, existingData}) => {
  ...
  const handleSubmit = async (e) => {
    ...
    //   console.log('Form Data:', formData);
      try {
        const response = await fetch(`${import.meta.env.VITE_APP_BACKEND_SERVER_URL}/tasks/${userId}`, {
            method: "POST",
  ...
  const handleEditSubmit = async (e) => {
    ...
    //   console.log('Form Data:', formData);
      try {
        const response = await fetch(`${import.meta.env.VITE_APP_BACKEND_SERVER_URL}/tasks/${userId}/${existingData._id}`, {
            method: "Put",
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify(formData)
        })
